...
DROP TRIGGER IF EXISTS {%prefix}M_GROUP_FUNCTION_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER {%prefix}M_GROUP_FUNCTION_UPDATE_TRIGGER AFTER UPDATE ON {%prefix}M_GROUP_FUNCTION FOR EACH ROW
BEGIN
    UPDATE
        {%prefix}M_GROUP_FUNCTION
    SET
