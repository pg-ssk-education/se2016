...
DROP TABLE IF EXISTS se2016_M_DOC_HEADER;

CREATE TABLE se2016_M_DOC_HEADER (
...
DROP TRIGGER IF EXISTS se2016_M_DOC_HEADER_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_M_DOC_HEADER_UPDATE_TRIGGER AFTER UPDATE ON se2016_M_DOC_HEADER FOR EACH ROW
BEGIN
    UPDATE
        se2016_M_DOC_HEADER
    SET
...
DROP TABLE IF EXISTS se2016_M_DOC_PAGE;

CREATE TABLE se2016_M_DOC_PAGE (
    DOC_ID           VARCHAR(16)    NOT NULL COMMENT '文書ID'
...
DROP TRIGGER IF EXISTS se2016_M_DOC_PAGE_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_M_DOC_PAGE_UPDATE_TRIGGER AFTER UPDATE ON se2016_M_DOC_PAGE FOR EACH ROW
BEGIN
    UPDATE
        se2016_M_DOC_PAGE
    SET
...
DROP TABLE IF EXISTS se2016_M_GROUP_FUNCTION;

CREATE TABLE se2016_M_GROUP_FUNCTION (
    GROUP_ID     VARCHAR(16)  NOT NULL COMMENT 'グループID'
   ,FUNCTION_ID  VARCHAR(16)  NOT NULL COMMENT '機能ID'
   ,INS_DATETIME DATETIME     NOT NULL COMMENT '追加日時'
   ,INS_USER_ID  INTEGER      NOT NULL COMMENT '追加ユーザID'
...
DROP TRIGGER IF EXISTS se2016_M_GROUP_FUNCTION_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_M_GROUP_FUNCTION_UPDATE_TRIGGER AFTER UPDATE ON se2016_M_GROUP_FUNCTION FOR EACH ROW
BEGIN
    UPDATE
        se2016_M_GROUP_FUNCTION
    SET
        UPD_DATETIME = CURRENT_TIMESTAMP
       ,REVISION = OLD.REVISION + 1
    WHERE
...
DROP TABLE IF EXISTS se2016_M_REQ_ROOT;

CREATE TABLE se2016_M_REQ_ROOT (
    DOC_ID       VARCHAR(16)   NOT NULL COMMENT '文書ID'
...
DROP TRIGGER IF EXISTS se2016_M_REQ_ROOT_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_M_REQ_ROOT_UPDATE_TRIGGER AFTER UPDATE ON se2016_M_REQ_ROOT FOR EACH ROW
BEGIN
    UPDATE
        se2016_M_REQ_ROOT
    SET
...
DROP TABLE IF EXISTS se2016_M_WF_ROUTE;

CREATE TABLE se2016_M_WF_ROUTE (
...
DROP TRIGGER IF EXISTS se2016_M_WF_ROUTE_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_M_WF_ROUTE_UPDATE_TRIGGER AFTER UPDATE ON se2016_M_WF_ROUTE FOR EACH ROW
BEGIN
    UPDATE
        se2016_M_WF_ROUTE
    SET
...
DROP TABLE IF EXISTS se2016_T_REQ_ITEM;

CREATE TABLE se2016_T_REQ_ITEM (
    REQ_ID       VARCHAR(16)   NOT NULL COMMENT '申請ID'
   ,PAGE_NUM     INTEGER       NOT NULL COMMENT 'ページ番号'
...
DROP TRIGGER IF EXISTS se2016_T_REQ_ITEM_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_T_REQ_ITEM_UPDATE_TRIGGER AFTER UPDATE ON se2016_T_REQ_ITEM FOR EACH ROW
BEGIN
    UPDATE
        se2016_T_REQ_ITEM
    SET
