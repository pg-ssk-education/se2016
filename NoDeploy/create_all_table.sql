...
DROP TABLE IF EXISTS se2016_T_INVALID_ACCESS;

CREATE TABLE se2016_T_INVALID_ACCESS (
...
DROP TRIGGER IF EXISTS se2016_T_INVALID_ACCESS_UPDATE_TRIGGER;
DELIMITER $$
CREATE TRIGGER se2016_T_INVALID_ACCESS_UPDATE_TRIGGER AFTER UPDATE ON se2016_T_INVALID_ACCESS FOR EACH ROW
BEGIN
    UPDATE
        se2016_T_INVALID_ACCESS
    SET
        UPD_DATETIME = CURRENT_TIMESTAMP
       ,REVISION = OLD.REVISION + 1
    WHERE
